...
class CreateDocumentIT extends BaseIT {
    ...
    void "CD1 (R1) As authenticated user upload 2 files with correct classification and some roles set"() {
        Response response = givenRequest(CITIZEN)
            ...
            .multiPart("files", file(ATTACHMENT_10), MediaType.TEXT_PLAIN_VALUE)
            ...
            .multiPart("files", file(ATTACHMENT_18), MediaType.TEXT_PLAIN_VALUE)
        ...
        .expect().log().all()
            ...
            .body("_embedded.documents[6].mimeType", equalTo(MediaType.TEXT_PLAIN_VALUE))
            ...
            .body("_embedded.documents[15].mimeType", equalTo(MediaType.TEXT_PLAIN_VALUE))
